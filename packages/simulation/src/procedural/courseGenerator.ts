...
function well(
  ...
  const classTuning = {
    standard:    { orbit: 28, acceleration: 8,  energy: 8,  boost: 1.5, acquire: 18, latch: 11.5, approach: -0.22, priority: 0.15  },
    accelerator: { orbit: 36, acceleration: 12, energy: 12, boost: 2.7, acquire: 19, latch: 12,   approach: -0.18, priority: 0.2   },
    precision:   { orbit: 30, acceleration: 7,  energy: 6,  boost: 1.9, acquire: 16, latch: 9.5,  approach: -0.08, priority: 0.12  },
    recovery:    { orbit: 23, acceleration: 6,  energy: 5,  boost: 1.1, acquire: 22, latch: 14,   approach: -0.65, priority: -0.05 },
  }[className];
