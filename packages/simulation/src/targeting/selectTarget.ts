...
import { sweepSphereAgainstHazards } from '../collision/sweep.js';
...
export interface TargetSelectionInput {
  ...
  playerRadius: number;
  /** [0, 1] — recovery-well fairness bias. Boosts recovery well score and relaxes approach filter. */
  recoveryBias?: number;
}
...
export function selectGravityTarget(input: TargetSelectionInput): TargetSelectionResult {
  ...
  // High bias relaxes the approach-cone filter for recovery wells
